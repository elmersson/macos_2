...
export function StageAndScreen() {
  return (
    <div className="flex flex-row space-x-2">
      <div className="rounded-md px-3 py-1 w-[100%] bg-clip-padding backdrop-filter backdrop-blur-3xl bg-slate-200/10 shadow-md flex justify-center items-center flex-col border-slate-400/40 border">
